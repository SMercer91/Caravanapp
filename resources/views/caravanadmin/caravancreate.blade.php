                    ...
                    <br />
                        <form action="/insert" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="extras" placeholder="Enter The Extras of The Caravan" required>
                            </div>

                            <div class="form-group">
                                <label for="DescriptionOfCaravan">Description</label>
                                <textarea class="form-control" input type="text"  name="description" placeholder="Enter The Description of The Caravan" required></textarea>
                            </div>
                            <div class="form-group">
