...
@section('content')
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;"/>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p>Humber Holiday Homes has a satisfied network of clients throughout the UK, Europe and other overseas destinations in which we also specialise in export. </p>

                        <p>We pride ourselves on good quality and good prices leading to many satisfied customers.</p>

                        <p>We supply a comprehensive range of static caravans with a large stock of makes, years, models and prices to suit every budget.</p>

                        <p>Whatever the customer's static caravan needs, Humber Holiday Homes will endeavour to give expert help to make the best choice for their needs.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    ...
                    <li>Self-build accommodation</li>
                    <li>Guest accommodation</li>
                    <li>Playroom/Games Room</li>
                    <li>Mobile office</li>
